...
welcome_label = Label(root, text = 'Welcome to the UCL Humanity Rescue Portal', font=('TkDefaultFont', 25, 'bold'), foreground='orange',)
welcome_label.pack(padx = 50, pady = 50)


instruction_label = Label(root, text = 'Please select admin or volunteer sign in', font=('TkDefaultFont', 20))
...
admin_sign_in_button = Button (root, text = 'Sign in as Admin', command= open_adminpage)
...
volunteer_sign_in_button = Button (root, text = 'Sign in as Volunteer', command= open_volunteerpage)
