...
class tvolunteer_main_page(t_deactivated_account, t_deleted_account, t_case_sensitive, t_no_text, t_incorrect_details):
    ...
    def t_volunteer_summary(self):
        ...
        self.t_summary_editdetails = tkinter.Button(self.t_summary_frame, text= 'Personal information', command=self.t_personal_information_base, height=2, width=20)
    ...
    def t_personal_information_base(self):
        ...
        t_edit_details = tkinter.Button(t_personal_frame, text='Edit details', command= self.t_personal_info_edit, height=1, width=20)
    ...
    def t_personal_info_edit(self):
        ...
        # Current email
        personal_email = tkinter.Label(t_personal_labelframe, text= self.y_personal_info[self.username]['Email Address'], font=('TkinterDefault', 15))
        ...
        phone_number = tkinter.Label(t_personal_labelframe, text= self.y_personal_info[self.username]['Phone Number'], font=('TkinterDefault', 15))
        ...
        # Commitment label
        commitment_label = tkinter.Label(t_personal_labelframe, text= self.y_personal_info[self.username]['Commitment'], font=('TkinterDefault', 15))
        ...
        # Work type label
        work_type_label = tkinter.Label(t_personal_labelframe, text= self.y_personal_info[self.username]['Work Type'], font=('TkinterDefault', 15))
    ...
    def t_edit_camp(self):
        ...
        t_camp_capacity = tkinter.Label(t_camp_labelframe, text='Capacity for new refugees:') #Need to add current number here next to it so Ying add that in with dictionary or however.
    ...
    def t_create_refugee(self):
        ...
        medical_conditionslabel = tkinter.Label(refugee_labelframe, text='Medical conditions', font=('TkinterDefault', 15))
    ...
    def t_display_resources(self):
        ...
        # Title
        resources_title = tkinter.Label(resources_frame, text= 'Resources Currently Available', font=('TkinterDefault', 30))
