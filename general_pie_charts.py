...
class SummaryCharts:
    ...
    def generate_charts_window(self):
        ...
        try:
            ...
            messagebox.showerror("File not found", "The file 'crisis_events.csv' was not found.\n\n"
                                                   "Unable to load summary charts.")
    ...
    def create_pie_chart_status(self, window):
        ...
        try:
            ...
            messagebox.showerror("File Not Found", "The 'crisis_events.csv' file was not found.\n\n"
